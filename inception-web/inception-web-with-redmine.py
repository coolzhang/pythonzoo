...
if not os.path.exists('./inception-web-with-redmine.conf'):
	...
	with open('./inception-web-with-redmine.conf', 'wb') as configfile:
		config.write(configfile)
config.read('./inception-web-with-redmine.conf')
